...
<head>
	...
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery-1.7.2.min.js"; ?>></script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/grid.locale-en.js"; ?>> </script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery-ui-1.10.4.custom.js"; ?>> </script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery.jqGrid.js"; ?>> </script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery.ui.datepicker.js"; ?>> </script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery.fancybox.js"; ?>> </script>
	<script src=<?php echo base_url("")."bonfire/themes/admin/js/jquery.PrintArea.js"; ?>> </script>
	
	
  	<link media="screen" href=<?php echo base_url("")."bonfire/themes/admin/css/ui.jqgrid.css"; ?> type="text/css" rel="stylesheet">
	<link media="screen" href=<?php echo base_url("")."bonfire/themes/admin/css/demos.css"; ?> type="text/css" rel="stylesheet">
	<link media="screen" href=<?php echo base_url("")."bonfire/themes/admin/css/jquery.ui.datepicker.css"; ?> type="text/css" rel="stylesheet">
	<link media="screen" href=<?php echo base_url("")."bonfire/themes/admin/css/jquery.fancybox.css"; ?> type="text/css" rel="stylesheet">
</head>
<body class="desktop"> 
<!--[if lt IE 7]>
...
<![endif]-->
	...
	<noscript>
		...
		<?php if (SITE_WEB != 'books') { ?>
			<div id="topbar1" style=" background-color: #FF0000; color: #FFFFFF; font-weight: bold; padding: 5px; position: fixed; text-align: center; width: 100%; z-index: 9999; top:0;">
				Development Version
			</div>
		<?php } ?>
		...
		<div class="navbar navbar-fixed-top" id="topbar" <?php echo (SITE_WEB != 'books') ? 'style="top:28px;"' : '' ?>>
 ...
 <div class="subnav navbar-fixed-top"  <?php echo (SITE_WEB != 'books') ? 'style="margin-top: 67px;"' : '' ?>>
	<div class="container-fluid">
