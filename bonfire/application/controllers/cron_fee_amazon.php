...
class cron_fee_amazon extends Front_Controller
{
	...
	public function __construct()
	{
		...
		$this -> amazon_cofiguration['id_report_fee'] = $amazon_cofiguration_query -> amazon_cofiguration_id_report_fee;
	...
	public function update_fee()
	{
		...
		if ($this -> amazon_cofiguration['id_report_fee'] == $report_id ) 
		{
			die('the report and revised, previously');
